...
public class NeededObj {
    ...
    private ClassInfo clsVO;
    private int depth;

    public NeededObj(String classSig, int depth) {
        super();
        this.classSig = classSig;
        this.clsVO = ProjectInfo.i().getClassInfo(classSig);
    ...
    public String getStatement(MethodInfo bestCons, boolean scanStatic) {
     ...
     * @return
     */
    private String getConsPre(MethodInfo bestCons) {
    ...
    public List<NeededObj> getConsParamObs(MethodInfo bestCons) {
    ...
    public boolean isSimpleType() {
        return simpleType.containsKey(classSig);
    }
