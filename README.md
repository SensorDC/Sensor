...
Although there will be no runtime exceptions in this case, the semantic inconsistencies between **_SevConfig.getSize()_* in **b-1.0.jar** and **b-2.0.jar** will inappropriately affect program behaviors of client project.
